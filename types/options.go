...
var (
	defaultConfigFile    = "/etc/gepis/storage.conf"
...
func init() {
	defaultStoreOptions.RunRoot = "/run/gepis/storage"
	defaultStoreOptions.GraphRoot = "/var/lib/gepis/storage"
...
type StoreOptions struct {
	...
	// default $HOME/.local/share/gepis/strge
	RootlessStoragePath string `toml:"rootless_storage_path"`
